#!/bin/bash -l
#SBATCH --job-name=Test5_NVT_Prod_Surfactant-Solvent
#SBATCH --nodes=1
...
# NVT Equilibration
mpirun gmx grompp -f mdp/nvt_prod.mdp -c equilibration/npt/npt_eq.gro -p top/system_surfactant_water.top -o production/nvt/nvt_prod.tpr
