...
cp ../../model_system/config-3/solvated_surfactant-120_polymer-20_toluene-12460_water_conf3.gro .

# simulation                
srun -n 1 -N 1 --mpi=pmix gmx grompp -f /lustre/ea-nrtmidas/users/3770/emulsion_stability/data/input/polymer_surfactant_solvent/mdp/em.mdp -c solvated_surfactant-120_polymer-20_toluene-12460_water_conf3.gro -p top/surfactant-120_polymer-20_toluene-12460_water_conf3.top -o emin_conf3.tpr
