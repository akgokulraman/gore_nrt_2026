...
cp ../../equilibration_NPT/box_length-34.5_.config-1_.polymer-68_.surfactant-608_.toluene-42053/npt_eq_conf1.gro .

# simulation                
srun -n 32 -N 1 --mpi=pmix gmx grompp -f /lustre/ea-nrtmidas/users/3770/emulsion_stability/data/input/polymer_surfactant_solvent/mdp/nvt_prod.mdp -c npt_eq_conf1.gro -p top/surfactant-608_polymer-68_toluene-42053_water_conf1.top -o nvt_prod_conf1.tpr
