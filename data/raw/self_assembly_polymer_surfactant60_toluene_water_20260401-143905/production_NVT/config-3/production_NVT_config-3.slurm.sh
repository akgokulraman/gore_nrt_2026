...
# simulation                
srun -n 32 -N 2 --mpi=pmix gmx grompp -f /lustre/ea-nrtmidas/users/3770/emulsion_stability/data/input/polymer_surfactant_solvent/mdp/nvt_prod.mdp -c npt_eq_conf3.gro -p top/surfactant-60_polymer-20_toluene-12460_water_conf3.top -o nvt_prod_conf3.tpr
