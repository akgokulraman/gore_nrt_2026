...
# simulation                
srun -n 32 -N 1 --mpi=pmix gmx grompp -f /lustre/ea-nrtmidas/users/3770/emulsion_stability/data/input/polymer_surfactant_solvent/mdp/npt_eq.mdp -c nvt_eq_conf1.gro -p top/surfactant-150_polymer-20_toluene-12460_water_conf1.top -o npt_eq_conf1.tpr
